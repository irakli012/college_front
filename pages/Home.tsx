    ...
    <div className="animate-fade-in">
      ...
      <section className="mt-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl font-extrabold tracking-tight mb-4">{t('home.ourMainPrograms')}</h2>
          <p className="text-gray-600 dark:text-gray-400">{t('home.programsDescription')}</p>
        </div>
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <div className="mt-auto">
                  <Link to={`/programs/${prog.slug}`} className="text-primary font-bold text-sm flex items-center gap-1 hover:gap-2 transition-all">
                    {t('home.learnMore')} <span className="material-symbols-outlined text-sm">chevron_right</span>
                  </Link>
                </div>
              </div>
            </div>
