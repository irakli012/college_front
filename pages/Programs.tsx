    ...
    <div className="animate-fade-in max-w-[1280px] mx-auto px-4 sm:px-10 py-10">
      <div className="flex flex-col gap-6 mb-10">
        <div className="flex flex-col gap-3">
          <h1 className="text-[#111318] dark:text-white text-4xl sm:text-5xl font-black leading-tight tracking-tight">Academic Programs</h1>
          <p className="text-[#616f89] dark:text-gray-400 text-lg font-normal max-w-2xl leading-relaxed">
            Explore our diverse range of multi-disciplinary programs designed to shape the leaders of tomorrow with hands-on learning and research excellence.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 mb-12">
          ...
          <label className="flex flex-col w-full">
            <div className="flex w-full items-stretch rounded-xl h-14 bg-white dark:bg-gray-900 border border-[#f0f2f4] dark:border-gray-800 shadow-sm focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
              ...
              <input 
                ...
                placeholder="Search for programs, majors, or keywords..." 
              />
            </div>
          </label>
        </div>
        ...
        <div className="flex gap-3 flex-wrap items-center">
          {faculties.map((fac) => (
            ...
            >
              <p className="text-sm leading-normal">{fac}</p>
        ...
        {filteredPrograms.map((prog) => (
          <div key={prog.id} className="group flex flex-col bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-[#f0f2f4] dark:border-gray-800 hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-[#111318] dark:text-white text-lg font-bold leading-tight group-hover:text-primary transition-colors">{prog.title}</h3>
      ...
      <div className="mt-16 flex flex-col items-center gap-4">
        ...
        <p className="text-[#616f89] dark:text-gray-400 text-sm">Showing {filteredPrograms.length} programs available</p>
      </div>
    </div>
  );
};
